...
public class DealtCardsTest implements WithAssertions {
    ...
    public void AceTo10InOrder() throws Exception {
        ...
        assertThat(dealtCards.cards).containsExactly(ACE_OF_SPADES, KING_OF_HEARTS, QUEEN_OF_SPADES, JACK_OF_DIAMONDS, TEN_OF_SPADES);
    }
    ...
    public void AceTo10InOrderDespiteDuplicates() throws Exception {
        ...
        assertThat(dealtCards.cards).containsExactly(ACE_OF_SPADES, KING_OF_HEARTS, JACK_OF_DIAMONDS, TEN_OF_SPADES, TEN_OF_SPADES);
    }
    ...
    public void AceToFiveInOrderWhereAceIsLast() throws Exception {
        ...
        assertThat(dealtCards.cards).containsExactly(FIVE_OF_DIAMONDS, FOUR_OF_CLUBS, THREE_OF_DIAMONDS, TWO_OF_HEARTS, ACE_OF_SPADES);
    }
    ...
    public void AceToFiveInOrderWhereAceIsLastWithDuplicates() throws Exception {
        ...
        assertThat(dealtCards.cards).containsExactly(FIVE_OF_DIAMONDS, THREE_OF_DIAMONDS, THREE_OF_DIAMONDS, TWO_OF_HEARTS, ACE_OF_SPADES);
    }
    ...
    public void NoAdjacentCardsAndAceIsAtStart() throws Exception {
        ...
        assertThat(dealtCards.cards).containsExactly(ACE_OF_SPADES, TEN_OF_SPADES, SIX_OF_HEARTS, FIVE_OF_DIAMONDS, THREE_OF_DIAMONDS);
    }
